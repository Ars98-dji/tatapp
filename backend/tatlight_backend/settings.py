# backend/tatlight_backend/settings.py - VERSION CORRIGÉE COMPLÈTE
"""
REMPLACER la section en haut de votre settings.py avec ce code
"""
...
ROOT_URLCONF = 'tatlight_backend.urls'
...
WSGI_APPLICATION = 'tatlight_backend.wsgi.application'
...
# Frontend URL (pour les redirections de paiement)
